          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div className="glass-card">
              ...
              <p style={{ fontSize: '0.9rem' }}>
                Our league collaborates with other local groups to host regional invitationals and annual tournaments. Contact Tim Hufler or another tournament organizer if you'd like your league to affiliate with Tournament of Champions Club.
              </p>
            </div>
