        ...
        <div className="about-grid">
          ...
          <div className="about-card glass-card" style={{ gridColumn: 'span 2' }}>
            <div className="about-card-header">
              ...
              <h2>Tournament of Champions — Poker Series Club</h2>
            </div>
            <p style={{ fontSize: '1.05rem', lineHeight: '1.6' }}>
              Welcome to the Tournament of Champions — Poker Series Club! We are a local home poker league dedicated to friendly competition, skill building, and camaraderie. We play structured tournaments running on regular schedules with points tracked across the season.
            </p>
