    ...
    <div className="player-page player-event-details-page animate-fade-in">
      ...
      <div className="player-page-content">
        ...
        {(() => {
          const seatingData = tournament.seating || (() => {
            const saved = localStorage.getItem(`tournament-of-champions_seating_${tournament.id}`);
      ...
      {(() => {
        ...
        const dealersData = tournament.dealers || (() => {
          const saved = localStorage.getItem(`tournament-of-champions_dealers_${tournament.id}`);
